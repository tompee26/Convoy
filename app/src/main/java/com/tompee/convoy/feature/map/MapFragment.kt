...
class MapFragment : BaseFragment(), MapView, OnMapReadyCallback, EasyPermissions.PermissionCallbacks {
    companion object {
...
//            intent.putExtra(SearchActivity.EMAIL, this@MapFragment.intent.getStringExtra(EMAIL))
...
//                .navigatorComponent(NavigationHostActivity[])
